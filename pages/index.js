  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center gap-0 flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          {/* title */}
          <motion.h1
          ...
          >
            I am a technology enthusiast currently training to become an
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[650px] max-h-[678px] absolute -bottom-16 lg:right-0"
        >
          <Avatar />
        </motion.div>
      </div>
